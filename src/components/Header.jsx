    ...
    <>
      ...
      {isScrolled && (
        <button
          ...
          className="fixed bottom-4 right-4 sm:bottom-8 sm:right-8 w-12 h-12 bg-white text-black rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-40 animate-bounce-subtle"
        >
