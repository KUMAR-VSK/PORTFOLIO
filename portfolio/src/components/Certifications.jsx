          ...
          {certifications.map((cert, index) => (
            ...
            >
              <div className="flex flex-col md:flex-row gap-6 items-start">
                {/* Icon */}
                <div className="w-20 h-20 bg-white/10 rounded-2xl flex items-center justify-center border border-white/20 group-hover:scale-110 group-hover:bg-white/20 transition-all flex-shrink-0 shadow-lg">
                  <span className="text-5xl grayscale group-hover:grayscale-0 transition-all">{cert.icon}</span>
                </div>
