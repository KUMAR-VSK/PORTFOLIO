          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="animate-slide-in-right">
              ...
              <div className="space-y-3 text-gray-300">
                ...
                <div className="flex items-center space-x-3">
                  <span className="text-white">💼</span>
                  <a href="https://linkedin.com/in/kumar-v-s-1695861b2" className="text-white hover:text-gray-400 transition-colors">
                    linkedin.com/in/kumar-v-s-1695861b2
                  </a>
                </div>
                <div className="flex items-center space-x-3">
                  <span className="text-white">🐙</span>
                  <a href="https://github.com/KUMAR-VSK" className="text-white hover:text-gray-400 transition-colors">
